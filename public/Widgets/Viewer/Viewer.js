...
Either specify options.terrainProvider instead or set options.baseLayerPicker to true.');
        ...
        var cesiumWidget = new CesiumWidget(cesiumWidgetContainer, {
            ...
            globeLightSensitivity : options.globeLightSensitivity || false,
            //caoyang 近地视角栅格瓦片渲染效果优化
            nearGroundTileOptimization : options.nearGroundTileOptimization || false,
            nearGroundTileLevel : options.nearGroundTileLevel || 17,
            //caoyang 阴影马赫带优化
            shadowMachBeltOptimization : options.shadowMachBeltOptimization || false,
